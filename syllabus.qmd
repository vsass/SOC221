...
**Contact:** We'll use {{< var slack.short >}} to communicate with each other and you can directly {{< var message >}} there.^[You can find the invitation to our private Slack on our {{< var canvas >}} homepage}.]\
