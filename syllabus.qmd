...
**Contact:** We'll use {{< var slack.short >}} to communicate with each other and you can directly {{< var message >}} there.[You can find the invitation to our private Slack on our {{< var canvas >}} homepage]{.aside}\
...
"1", "Friday<br>June 21st", "", "", "Homework 1",
# week 2
"2", "Monday<br>June 24th", "▪ Frequency tables<br>▪ Graphical techniques", "Chapter 1 (sections 1.3 - 1.4)<br>Chapter 2 (sections 2.1 - 2.4)", "<i>Homework 1 returned</i>",
"2", "Wednesday<br>June 26th", "▪ Measures of central tendency<br>▪ Measures of variability", "Chapter 2 (sections 2.5 - 2.6)<br>Chapter 2 (sections 2.7 - 2.8)", "Homework 1 w/ revisions",
"2", "Friday<br>June 28th", "", "", "Homework 2",
# week 3
"3", "Monday<br>July 1st", "▪ Probability and probability distributions<br>▪ Normal distributions", "Chapter 3 (sections 3.1 to 3.3)<br>Chapter 4 (section 4.1)<br>Chapter 5 (section 5.1)<br>Chapter 6 (sections 6.1 to 6.2)", "<i>Homework 2 returned</i>",
"3", "Wednesday<br>July 3rd", "✍️🙋💡Quiz 1 & Review", "","Homework 2 w/ revisions",
"3", "Friday<br>July 5th", "", "", "Homework 3",
# week 4 
"4", "Monday<br>July 8th", "▪ Sampling distributions<br>▪ Central limit theorem<br>▪ Logic of inference", "Chapter 7 (sections 7.1 & 7.3)", "<i>Homework 3 returned</i>",
"4", "Wednesday<br>July 10th", "▪ Estimation: confidence intervals for means<br>▪ Estimation: confidence intervals for proportions", "Chapter 8 (sections 8.1 to 8.2)<br>Chapter 8 (section 8.3)", "Homework 3 w/ revisions",
"4", "Thursday<br>July 11th", "Individual Learning Assessment Meetings<br>(via Zoom)", "", "",
"4", "Friday<br>July 12th", "Individual Learning Assessment Meetings<br>(via Zoom)", "", "Homework 4",
# week 5
"5", "Monday<br>July 15th", "▪ Hypothesis testing for one sample<br>▪ Hypothesis testing for two samples", "Chapter 9 (sections 9.1 to 9.6)<br>Chapter 10 (sections 10.1 to 10.3 plus 10.5)", "<i>Homework 4 returned</i>",
"5", "Wednesday<br>July 17th", "✍️🙋💡Quiz 2 & Review", "", "Homework 4 w/ revisions",
"5", "Friday<br>July 19th", "", "", "Homework 5",
# week 6
"6", "Monday<br>July 22nd", "▪ Two-way tables and chi-square<br>▪ Scatterplots and correlation", "Chapter 11 (sections 11.1 to 11.3<br>Chapter 12 (sections 12.1 to 12.3)", "<i>Homework 5 returned</i>",
"6", "Wednesday<br>July 24th", "▪ Bivariate regression<br>▪ Inference for regression", "Chapter 12 (section 12.4 and 12.5)", "Homework 5 w/ revisions",
"6", "Friday<br>July 26th", "", "", "Homework 6",
# week 7
"7", "Monday<br>July 29th", "▪ Multivariate regression", "Primer for multivariate regression", "<i>Homework 6 returned</i>",
"7", "Wednesday<br>July 31st", "▪ Multivariate regression", "", "Homework 6 w/ revisions",
"7", "Friday<br>August 2nd", "", "", "Homework 7",
# week 8
"8", "Monday<br>August 5th", "Individual Learning Assessment Meetings<br>(in-person)", "", "<i>Homework 7 returned</i>",
"8", "Wednesday<br>August 7th", "✍️🙋💡Quiz 3 & Review", "", "", 
"8", "Friday<br>August 9th", "", "", "Homework 7 w/ revisions")
...
tab_style(style = cell_fill(color = "#ccebc5"), # homework due
              locations = list(cells_body(columns = c(due),
                                          rows = date %in% c("Friday<br>June 21st", "Friday<br>June 28th", "Friday<br>July 5th", "Friday<br>July 12th", "Friday<br>July 19th", "Friday<br>July 26th", "Friday<br>August 2nd")))) |> 
# homework returned
tab_style(style = cell_fill(color = "#fddaec"),
              locations = list(cells_body(columns = c(due),
                                          rows = date %in% c("Monday<br>June 24th", "Monday<br>July 1st", "Monday<br>July 8th", "Monday<br>July 15th", "Monday<br>July 22nd", "Monday<br>July 29th", "Monday<br>August 5th")))) |> 
tab_style(style = cell_text(color = "#e7298a"),
              locations = list(cells_body(columns = c(due),
                                          rows = date %in% c("Monday<br>June 24th", "Monday<br>July 1st", "Monday<br>July 8th", "Monday<br>July 15th", "Monday<br>July 22nd", "Monday<br>July 29th", "Monday<br>August 5th")))) |> 
# homework w/ revisions due
tab_style(style = cell_fill(color = "#fed9a6"),
              locations = list(cells_body(columns = c(due),
                                          rows = date %in% c("Wednesday<br>June 26th", "Wednesday<br>July 3rd", "Wednesday<br>July 10th", "Wednesday<br>July 17th", "Wednesday<br>July 24th", "Wednesday<br>July 31st", "Friday<br>August 9th")))) |> 
# quiz & review day
...
tab_style(style = cell_fill(color = "#cccccc"),
              locations = list(cells_body(columns = c(week, date, topic, reading, due),
                                          rows = date == "Wednesday<br>June 19th"))) |> 
...
tab_style(style = cell_fill(color = "#f2f2f2"),
              locations = list(cells_body(columns = c(week, date, topic, reading, due),
                               ...
                               cells_body(columns = c(week, date, topic, reading),
                                          rows = date %in% c("Friday<br>June 21st", "Monday<br>June 24th", "Wednesday<br>June 26th", "Friday<br>June 28th", "Monday<br>July 1st", "Friday<br>July 5th", "Monday<br>July 8th", "Wednesday<br>July 10th", "Monday<br>July 15th", "Friday<br>July 19th", "Monday<br>July 22nd", "Wednesday<br>July 24th", "Friday<br>July 26th", "Monday<br>July 29th", "Wednesday<br>July 31st", "Friday<br>August 2nd", "Friday<br>August 9th")), 
                                cells_body(columns = c(week, date, reading),
                                          rows = date %in% c("Wednesday<br>July 3rd", "Friday<br>July 12th", "Wednesday<br>July 17th", "Monday<br>August 5th")), 
                                cells_body(columns = c(week, date, reading, due),
                                          rows = date %in% c("Thursday<br>July 11th", "Wednesday<br>August 7th")))) |> 
...
Students are expected to abide by established regulations on student conduct. Any student found in violation of rules of student conduct will be removed from the class in accordance with state policy and appropriate disciplinary action will be pursued.[You can read more about the University of Washington Student Code [here](http://www.washington.edu/cssc/student-conduct-overview/student-code-of-conduct/ ).]{.aside} 


### Basic needs statement	

If you find yourself in need of health services, housing, food, or other basic resources, please use the resources listed below and/or visit the Resources page on the Sociology Department’s website.  If you feel comfortable doing so, please contact me about any other unmet needs so that we can brainstorm other resources. 
...
- [Hall Health](http://depts.washington.edu/hhpccweb/)
- [Hall Health Mental Health](http://depts.washington.edu/hhpccweb/project/mental-health-clinic/)
- [Sexual Assault Resources](http://www.washington.edu/sexualassault/)
- [Q Center](http://depts.washington.edu/qcenter/wordpress/) (for queer community, including questioning)  
- [Disability Resources for Students](http://depts.washington.edu/uwdrs/)
- [wǝɫǝbʔaltxʷ](https://www.washington.edu/diversity/tribal-relations/intellectual-house/) – Intellectual House (for indigenous community) 
