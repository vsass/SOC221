...
## {background-iframe="https://www.youtube.com/embed/7S7j75d3GM4?si=6AYo5jazatpUXCSg&amp;start=5&end=360" background-interactive=true}
...
The standard deviation in<br>the sampling distribution<br>
...
ggplot(data = data.frame(x = c(-3.25, 3.25)), aes(x)) +
  ...
  annotate(geom = "segment", x = -1, y = 0.12, xend = 1, yend = .12, arrow = arrow(ends = "both", type = "closed")) + 
  annotate(geom = "label", x = 0, y = 0.12, label = "68.26%", fill = "#a68100", color = "white") + 
  annotate(geom = "segment", x = -2, y = 0.053991, xend = 2, yend = 0.053991, arrow = arrow(ends = "both", type = "closed")) + 
  annotate(geom = "label", x = 0, y = 0.053991, label = "95.44%") + 
  annotate(geom = "segment", x = -3, y = 0.01, xend = 3, yend = 0.01, arrow = arrow(ends = "both", type = "closed")) +
  annotate(geom = "label", x = 0, y = 0.01, label = "99.74%") + 
...
ggplot(data = data.frame(x = c(-3.25, 3.25)), aes(x)) +
  ...
  annotate(geom = "label", x = 0, y = 0.12, label = "68.26%") + 
  annotate(geom = "segment", x = -2, y = 0.053991, xend = 2, yend = 0.053991, arrow = arrow(ends = "both", type = "closed")) + 
  annotate(geom = "label", x = 0, y = 0.053991, label = "95.44%", fill = "#754cbc", color = "white") + 
  annotate(geom = "segment", x = -3, y = 0.01, xend = 3, yend = 0.01, arrow = arrow(ends = "both", type = "closed")) +
  annotate(geom = "label", x = 0, y = 0.01, label = "99.74%") + 
  geom_hline(yintercept = 0, color = "black") + 
  theme_tufte(base_size = 16)
...
ggplot(data = data.frame(x = c(-3.25, 3.25)), aes(x)) +
  ...
  geom_segment(x = -3, y = 0, yend = 0.004432, color = "black") + 
  geom_segment(x = 3, y = 0, yend = 0.004432, color = "black") + 
  geom_ribbon(data = area_minus1, mapping = aes(x = x, ymin = ymin, ymax = ymax), fill = "#2ad2c9", alpha = 0.5) +
  geom_ribbon(data = area1, mapping = aes(x = x, ymin = ymin, ymax = ymax), fill = "#2ad2c9", alpha = 0.5) +
  geom_ribbon(data = area_minus2, mapping = aes(x = x, ymin = ymin, ymax = ymax), fill = "#2ad2c9", alpha = 0.5) +
  geom_ribbon(data = area2, mapping = aes(x = x, ymin = ymin, ymax = ymax), fill = "#2ad2c9", alpha = 0.5) +
  geom_ribbon(data = area_minus3, mapping = aes(x = x, ymin = ymin, ymax = ymax), fill = "#2ad2c9", alpha = 0.5) +
  geom_ribbon(data = area3, mapping = aes(x = x, ymin = ymin, ymax = ymax), fill = "#2ad2c9", alpha = 0.5) +
  annotate(geom = "segment", x = -1, y = 0.12, xend = 1, yend = .12, arrow = arrow(ends = "both", type = "closed")) + 
  annotate(geom = "label", x = 0, y = 0.12, label = "68.26%") + 
  annotate(geom = "segment", x = -2, y = 0.053991, xend = 2, yend = 0.053991, arrow = arrow(ends = "both", type = "closed")) + 
  annotate(geom = "label", x = 0, y = 0.053991, label = "95.44%") + 
  annotate(geom = "segment", x = -3, y = 0.01, xend = 3, yend = 0.01, arrow = arrow(ends = "both", type = "closed")) +
  annotate(geom = "label", x = 0, y = 0.01, label = "99.73%", , fill = "#1b8883", color = "white") + 
  geom_hline(yintercept = 0, color = "black") + 
  theme_tufte(base_size = 16)
```
:::

::: {data-id="box2" style="background: #2ad2c9; border: 4px solid #1b8883; border-radius: 15px; width: 500px; padding: 5px 5px 5px 5px; position: absolute; bottom: 140px; left: -75px; text-align: center; font-size: 0.9em"}
...
sample_means <- ggplot(twenty_randos, aes(group = y)) + 
  ...
  geom_text(data = twenty_randos[1, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[1]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[2, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[2]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[3, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[3]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[4, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[4]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[5, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[5]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[6, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[6]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[7, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[7]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[8, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[8]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[9, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[9]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[10, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[10]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[11, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[11]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[12, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[12]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[13, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[13]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[14, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[14]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[15, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[15]))), parse = TRUE, color = "#6e8e13", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[16, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[16]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[17, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[17]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[18, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[18]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[19, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[19]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[20, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[20]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  coord_fixed(bin_width, clip = "off") + # to make the dots look nice and round
  theme(legend.position = "none", axis.text.x = element_text(size = 30, color = "#e93cac"), axis.ticks.x = element_blank()) +
  scale_y_continuous(name = NULL, breaks = NULL, limits = c(0, 21)) + 
  scale_x_continuous(name = NULL, limits = c(-5.5, 5.5), breaks = c(-1.96, 1.96), label = c(expression(paste(bar(X), " - 1.96",sigma[bar(X)])), 
  expression(paste(bar(X), " + 1.96",sigma[bar(X)])))) + 
...
ggplot(twenty_randos, aes(group = y)) + 
  ...
  geom_text(data = twenty_randos[8, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[8]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[9, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[9]))), parse = TRUE, color = "#e93cac", size = 7.7, fontface = "bold") +
  geom_text(data = twenty_randos[10, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[10]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[11, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[11]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[12, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[12]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[13, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[13]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
  geom_text(data = twenty_randos[14, ], aes(x = x, y = y, label = deparse(bquote(bar(X)[14]))), parse = TRUE, color = "#e93cac", size = 6.7, fontface = "bold") +
...
## {background-iframe="https://www.youtube.com/embed/ivd8wEHnMCg?si=P5sc4yQCn8hoJaRc&amp;start=5&end=385" background-interactive=true}
...
b. According to the Central Limit Theorem, what is the shape of the sampling distribution of $\bar{X}$? Why?
c. Would the standard error be larger, smaller, or the same if the sample size were only 25? Explain your reasoning.
...
a.	If we take a random sample of 5 people, will the distribution of the sample mean look approximately normal? Why or why not?
b.	What about a sample of 50 people?
c.	Explain why the CLT is important for making inferences using sample means, even when the population distribution is not normal.
...
::: {.incremental}
a. $n = 5$: The sampling distribution of $\bar{X}$ is **not** approximately normal — small sample from a strongly skewed population.\

b. $n = 50$: Sampling distribution **is approximately normal** — CLT applies for large enough $n$ (typically $n \geq 30$).\
...
### Practice
#### Problem 3: Comparing Sample Means 

Two different researchers each take a simple random sample from the same population of high school students.

- Researcher A: $n = 30$, gets $\bar{X}_A = 7$ hours of sleep per night
- Researcher B: n = 90, gets $\bar{X}_B = 7.2$ hours of sleep per night
- The population standard deviation is known to be $\sigma$ = 1.8 hours

a. Who would have a smaller standard error, and why?
b. Without calculating exact probabilities, which researcher is more likely to have a sample mean close to the true population mean?
c. What does this example illustrate about the relationship between sample size and variability in sample statistics?
