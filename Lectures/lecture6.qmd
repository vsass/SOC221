...
::: {.fragment fragment-index=1 data-id="box2" style="background: #aadb1e; border: 4px solid #6e8e13; border-radius: 15px; width: 350px; padding: 0px 0px 0px 0px; position: absolute; top: 70px; right: -75px; font-size: 0.85em; text-align: center"}
$\text{sample statistic} \pm \text{margin of error}$
:::
...
::: {data-id="box5" style="background: #c5b4e3; border: 4px solid #754cbc; border-radius: 15px; padding: 10px 10px 10px 10px; position: absolute; top: 425px; left: 185px"}
Building a [*margin of error*]{style="color:#e93cac"} around our sample proportion
:::
...
#### [Household Purchasing Decisions]{.underline}
...
#### [Identify the sample proportion]{.underline}
...
#### [Compute the standard error]{.underline}
...
#### [Compute the margin of error]{.underline}
...
#### [Compute the confidence interval]{.underline}
...
We are [95% confident]{.underline} that between [53.2% and 66.8%]{.underline} of [the population of all households]{.underline} have women making the majority of purchasing decisions.
