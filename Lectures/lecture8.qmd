...
death_penalty_chi <- data.frame(Black = c("$$f_0 = 60$$ \n $$f_e = 83.36$$ \n (57.69%)", 
                                          "$$f_0 = 44$$ \n $$f_e = 20.64$$ \n (42.31%)",  
                                          "104 <br> (100.00%)"), 
                                White = c("$$f_0 = 659$$ \n $$f_e = 635.64$$ \n (83.10%)", 
                                          "$$f_0 = 134$$ \n $$f_e = 157.36$$ \n (16.90%)", 
...
::: {.fragment fragment-index=1 style="border: 3px solid #1b8883; border-radius: 15px; padding: 5px 5px 5px 5px; width: 75px; height: 150px; position: absolute; bottom: -21px; right: 272px; text-align: center"}
...
::: {style="border: 3px solid #1b8883; border-radius: 15px; padding: 5px 5px 5px 5px; width: 75px; height: 150px; position: absolute; bottom: -21px; right: 272px; text-align: center"}
...
thanksgiving <- data.frame(Vegetarian = c("25 \n \n", 
                                          "36",
                                          "",
                                          "100"), 
                                Carnivore = c("", 
                                          ...
                                          "275"), 
                                TOTAL = c("80", "111 \n \n", "184 \n \n", "375"))
rownames(thanksgiving) <- c("Dislikes", "Indifferrent to", "Likes", "TOTAL")
