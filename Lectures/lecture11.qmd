...
> [**PARTIAL SLOPE**]{style="color: #e93cac"}: <br>
...
1. [We can reduce our errors by almost 73% if we take into consideration individuals’ education when we predict their income (i.e., use the regression line in our predictions).]{style="color: #754cbc"}
...
1. [We can reduce our errors by about 81% if we take into consideration individuals’ [education and the wealth of their parents]{.underline} when we predict their income (i.e., use the regression line in our predictions).]{style="color: #754cbc"}
...
educ_income |> 
  ...
  tab_style(style = list(cell_text(color = "#e8e3d3")), 
            locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = c(model2, stars2))))  |> 
  tab_style(style = list(cell_text(color = "#1b8883", weight = "bold")), locations = list(cells_body(rows = "Education", column = model1)))  |> 
  tab_stub_indent(rows = c("Education", "Parental wealth"), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
  tab_options(table.background.color = "#e8e3d3") |> # change background color
  opt_table_outline(color = "#85754d") |> # outline table with colored border 
...
educ_income |> 
  ...
  cols_label(model1 = "Model 1", model2 = "Model 2") |> 
  tab_row_group(label = "Predictor", rows = c("Education", "Parental wealth")) |> 
  tab_source_note(html("N = 12 <br> <span style='color: #e93cac; font-weight:bold;'> * p < 0.05 &emsp; ** p < 0.01 &emsp; *** p < 0.001 </span>")) |> 
  tab_style(style = list(cell_text(color = "#e8e3d3")), 
            locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = c(model2, stars2))))  |> 
  tab_style(style = list(cell_text(color = "#1b8883")), locations = list(cells_body(rows = "Education", column = model1)))  |> 
  tab_style(style = list(cell_text(color = "#e93cac", weight = "bold")), locations = list(cells_body(rows = "Education", column = stars1)))  |> 
  tab_stub_indent(rows = c("Education", "Parental wealth"), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
  tab_options(table.background.color = "#e8e3d3") |> # change background color
  opt_table_outline(color = "#85754d") |> # outline table with colored border 
...
educ_income |> 
  ...
  tab_style(style = list(cell_text(color = "#e8e3d3")), 
            locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = c(model2, stars2))))  |> 
  tab_style(style = list(cell_text(color = "#1b8883")), locations = list(cells_body(rows = "Education", column = model1)))  |>
  tab_style(style = list(cell_text(color = "#754cbc", weight = "bold")), locations = list(cells_body(rows = "Constant", column = model1)))  |> 
  tab_stub_indent(rows = c("Education", "Parental wealth"), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
  tab_options(table.background.color = "#e8e3d3") |> # change background color
  opt_table_outline(color = "#85754d") |> # outline table with colored border 
...
educ_income |> 
  ...
  tab_style(style = list(cell_text(color = "#754cbc")), locations = list(cells_body(rows = "Constant", column = model1)))  |> 
    tab_style(style = list(cell_text(color = "#a68100", weight = "bold")), locations = list(cells_body(rows = "Model $R^2$", column = model1)))  |> 
  tab_stub_indent(rows = c("Education", "Parental wealth"), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
  tab_options(table.background.color = "#e8e3d3") |> # change background color
  opt_table_outline(color = "#85754d") |> # outline table with colored border 
...
educ_income |> 
  ...
  tab_row_group(label = "Predictor", rows = c("Education", "Parental wealth")) |> 
  tab_source_note(html("N = 12 <br> * p < 0.05 &emsp; ** p < 0.01 &emsp; *** p < 0.001")) |> 
  tab_style(style = list(cell_text(color = "#1b8883", weight = "bold")), locations = list(cells_body(rows = "Education", column = model2)))  |>
  tab_style(style = list(cell_text(color = "#6e8e13", weight = "bold")), locations = list(cells_body(rows = "Parental wealth", column = model2)))  |>
  tab_style(style = list(cell_text(color = "#754cbc", weight = "bold")), locations = list(cells_body(rows = "Constant", column = model2)))  |> 
  tab_style(style = list(cell_text(color = "#a68100", weight = "bold")), locations = list(cells_body(rows = "Model $R^2$", column = model2)))  |> 
...
educ_income |> 
  ...
  tab_row_group(label = "Predictor", rows = c("Education", "Parental wealth")) |> 
  tab_source_note(html("N = 12 <br> <span style='color: #e93cac; font-weight:bold;'> * p < 0.05 &emsp; ** p < 0.01 &emsp; *** p < 0.001 </span>")) |> 
  tab_style(style = list(cell_text(color = "#e93cac", weight = "bold")), locations = list(cells_body(rows = c("Education", "Parental wealth"), column = stars2)))  |> 
...
minority_poverty |> 
  ...
  #tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = model2)))  |> 
  tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, stars2))))  |> 
  tab_stub_indent(rows = c(1:2), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |>
  tab_options(table.background.color = "#e8e3d3") |> # change background color
  opt_table_outline(color = "#85754d") |> # outline table with colored border 
  tab_options(table.background.color = "#e8e3d3", table_body.hlines.color = "#85754d", table_body.vlines.color = "#85754d", table_body.border.top.color = "#85754d", table_body.border.bottom.color = "#85754d", stub.border.color = "#85754d", heading.border.bottom.color = "#85754d",  column_labels.border.bottom.color = "#85754d", table.width = pct(100), table.font.size = px(18L)) 
...
minority_poverty |> 
  ...
  tab_style(style = list(cell_text(color = "#e93cac")), 
            locations = list(cells_body(column = c(model1, stars1),
                                        rows = 1)))  |> 
  tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, stars2))))  |> 
  tab_stub_indent(rows = c(1:2), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
...
minority_poverty |> 
  ...
  tab_style(style = list(cell_text(color = "#e8e3d3")), 
            locations = list(cells_column_labels(c(stars1, stars2))))  |> 
  tab_stub_indent(rows = c(1:2), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
  tab_options(table.background.color = "#e8e3d3") |> # change background color
  opt_table_outline(color = "#85754d") |> # outline table with colored border 
...
minority_poverty |> 
  ...
  tab_source_note(html("N =  6,935 <br> * p < 0.05 &emsp; ** p < 0.01 &emsp; *** p < 0.001")) |> 
  tab_style(style = list(cell_text(color = "#e93cac")), 
            locations = list(cells_body(column = c(model2, stars2), rows = 1)))  |> 
  #tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = model2)))  |> 
  tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, stars2))))  |> 
  tab_stub_indent(rows = c(1:2), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
...
minority_poverty |> 
  ...
  tab_source_note(html("N =  6,935 <br> * p < 0.05 &emsp; ** p < 0.01 &emsp; *** p < 0.001")) |> 
  tab_style(style = list(cell_text(color = "#e93cac")), 
            locations = list(cells_body(column = c(model2, stars2), rows = 2)))  |> 
  #tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = model2)))  |> 
  tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, stars2))))  |> 
  tab_stub_indent(rows = c(1:2), indent = 5) |> 
  cols_width(stub() ~ pct(30), model1 ~ pct(25), stars1 ~ pct(10), model2 ~ pct(25),  stars2 ~ pct(10)) |> 
...
minority_poverty |> 
  ...
  tab_source_note(html("N =  6,935 <br> * p < 0.05 &emsp; ** p < 0.01 &emsp; *** p < 0.001")) |> 
    tab_style(style = list(cell_text(color = "#e93cac")), 
            locations = list(cells_body(rows = c(1:3), 
                                        columns = model2)))  |>
  #tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, model2, stars2)), cells_body(column = model2)))  |> 
  tab_style(style = list(cell_text(color = "#e8e3d3")), locations = list(cells_column_labels(c(stars1, stars2))))  |> 
  tab_stub_indent(rows = c(1:2), indent = 5) |> 
