...
<br>&emsp;2) under certain conditions,<br>&emsp;distributions that we need to<br>&emsp;knowabout follow a normal curve
...
[$$z = \frac{69-65}{3.5} = 1.14$$]{style="color:#754cbc; font-size: 1.7em"}

[$$z = \frac{55-65}{3.5} = -2.86$$]{style="color:#6e8e13; font-size: 1.7em"}

[$$z = \frac{60-65}{3.5} = -1.43$$]{style="color:#1b8883; font-size: 1.7em"}
