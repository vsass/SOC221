...
ggplot(data = heights, aes(x = x)) +
  stat_function(fun = dnorm, n = 101, args = list(mean = 65, sd = 3.5), color = "#a68100", size = 1) + 
...
#### [Think creatively to use the information in Normal Table to figure out what you want to know]{style="color: #e93cac; font-size: 0.9em"}
...
#### [Percentage of women shorter than 55 inches?]{style="color: #e93cac;"}
...
::: {data-id="box3" style="width: 385px; padding: 10px 10px 10px 10px; position: absolute; bottom: 250px; right: -75px; color: #e93cac"}
$$
\text{Percentage}(<55) = 
.00289(100) =
.29\%
...
#### [Percentage of women 55 inches or taller?]{style="color: #e93cac;"}
...
#### [Probability of randomly selecting a woman who is 69 inches or taller?]{style="color: #e93cac;"}


---

#### [Probability of randomly selecting two women, on consecutive draws, who are 69 inches or taller?]{style="color: #e93cac;"}


---

#### [Find the score at the 10th percentile in the distribution.]{style="color: #e93cac;"}


---

#### [Find the two heights that define the middle 95% of cases in the distribution.]{style="color: #e93cac;"}
