...
[[PROBLEM]{.underline}: Using sample statistics to make<br>two different inferences]{style="font-size: .75em"} <br>
...
::: {.fragment style="position: absolute; top: 190px; right: -50px"}
...
: For 95% confidence level<br>($\alpha = 0.05$, two-sided)
:::
...
**Notice**: Tests with the [t-distribution]{style="color: #e93cac"} are more conservative (wider confidence intervals, harder to reject $H_0$) than with normal (critical value: **$\pm1.960$**) and results are [especially conservative]{.underline} when the [sample size (df) is small]{.underline}.
:::
...
::: {.column width="30%"}
::: {.fragment}
[$H_0: \mu_{UW} - \mu_{WSU} = 0$]{style="background: #c5b4e3; border: 4px solid #754cbc; border-radius: 15px; padding: 5px 5px 5px 5px; text-align: center; font-size: 1.15em"} 
<br>
<br>
<br>
<br>
<br>
<br>
[$H_a: \mu_{UW} - \mu_{WSU} \ne 0$]{style="background: #aadb1e; border: 4px solid #6e8e13; border-radius: 15px; padding: 5px 5px 5px 5px; text-align: center; font-size: 1.15em"}
:::
:::
...
::: {.column width="35%"}
::: {.fragment style="border: 4px solid #754cbc; border-radius: 15px; padding: 1px 1px 1px 1px; text-align: center; width: 350px"}
Observed difference between sample means reflects chance sampling error.
:::

<br>

::: {.fragment style="border: 4px solid #6e8e13; border-radius: 15px; padding: 1px 1px 1px 1px; text-align: center; width: 350px; margin: 10px"}
...
* $\bar{X}_{UW1} - \bar{X}_{WSU1} = \bar{X}_\text{diff1}$ <br>
* $\bar{X}_{UW2} - \bar{X}_{WSU2} = \bar{X}_\text{diff2}$ <br>
* $\bar{X}_{UW3} - \bar{X}_{WSU3} = \bar{X}_\text{diff3}$ <br>
* . . . 
:::
...
<br>
<br>
[Two-sided test]{.fragment fragment-index=2 style="color: #1b8883; border: 3px solid #1b8883; border-radius: 15px; padding: 5px 5px 5px 5px; width: 150px"}
:::
:::
...
::: {style="border: 3px solid #1b8883; width: 135px; height: 48px; position: absolute; bottom: 70px; left: 475px"}
:::
...
::: {style="border: 3px solid #754cbc; width: 30px; height: 45px; position: absolute; bottom: 70px; left: 625px"}
:::
...
::: {.fragment .fade-out fragment-index=2 style="border: 3px solid #a68100; width: 130px; height: 50px; position: absolute; bottom: 10px; left: 495px"}
:::
